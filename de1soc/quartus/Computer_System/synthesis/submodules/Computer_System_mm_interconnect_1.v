...
module Computer_System_mm_interconnect_1 (
	...
	wire  [112:0] fifo_hps_to_fpga_in_csr_agent_rf_source_data;                  // fifo_HPS_to_FPGA_in_csr_agent:rf_source_data -> fifo_HPS_to_FPGA_in_csr_agent_rsp_fifo:in_data
	...
	wire  [112:0] fifo_hps_to_fpga_in_csr_agent_rsp_fifo_out_data;               // fifo_HPS_to_FPGA_in_csr_agent_rsp_fifo:out_data -> fifo_HPS_to_FPGA_in_csr_agent:rf_sink_data
	...
	wire  [112:0] fifo_fpga_to_hps_out_csr_agent_rf_source_data;                 // fifo_FPGA_to_HPS_out_csr_agent:rf_source_data -> fifo_FPGA_to_HPS_out_csr_agent_rsp_fifo:in_data
	...
	wire  [112:0] fifo_fpga_to_hps_out_csr_agent_rsp_fifo_out_data;              // fifo_FPGA_to_HPS_out_csr_agent_rsp_fifo:out_data -> fifo_FPGA_to_HPS_out_csr_agent:rf_sink_data
	...
	wire          fifo_hps_to_fpga_in_csr_agent_rp_valid;                        // fifo_HPS_to_FPGA_in_csr_agent:rp_valid -> router_002:sink_valid
	wire  [111:0] fifo_hps_to_fpga_in_csr_agent_rp_data;                         // fifo_HPS_to_FPGA_in_csr_agent:rp_data -> router_002:sink_data
	wire          fifo_hps_to_fpga_in_csr_agent_rp_ready;                        // router_002:sink_ready -> fifo_HPS_to_FPGA_in_csr_agent:rp_ready
	wire          fifo_hps_to_fpga_in_csr_agent_rp_startofpacket;                // fifo_HPS_to_FPGA_in_csr_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          fifo_hps_to_fpga_in_csr_agent_rp_endofpacket;                  // fifo_HPS_to_FPGA_in_csr_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire          fifo_fpga_to_hps_out_csr_agent_rp_valid;                       // fifo_FPGA_to_HPS_out_csr_agent:rp_valid -> router_003:sink_valid
	wire  [111:0] fifo_fpga_to_hps_out_csr_agent_rp_data;                        // fifo_FPGA_to_HPS_out_csr_agent:rp_data -> router_003:sink_data
	wire          fifo_fpga_to_hps_out_csr_agent_rp_ready;                       // router_003:sink_ready -> fifo_FPGA_to_HPS_out_csr_agent:rp_ready
	wire          fifo_fpga_to_hps_out_csr_agent_rp_startofpacket;               // fifo_FPGA_to_HPS_out_csr_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          fifo_fpga_to_hps_out_csr_agent_rp_endofpacket;                 // fifo_FPGA_to_HPS_out_csr_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [111:0] router_src_data;                                               // router:src_data -> ARM_A9_HPS_h2f_lw_axi_master_wr_limiter:cmd_sink_data
	wire          router_src_ready;                                              // ARM_A9_HPS_h2f_lw_axi_master_wr_limiter:cmd_sink_ready -> router:src_ready
	wire    [1:0] router_src_channel;                                            // router:src_channel -> ARM_A9_HPS_h2f_lw_axi_master_wr_limiter:cmd_sink_channel
	...
	wire  [111:0] arm_a9_hps_h2f_lw_axi_master_wr_limiter_cmd_src_data;          // ARM_A9_HPS_h2f_lw_axi_master_wr_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire    [1:0] arm_a9_hps_h2f_lw_axi_master_wr_limiter_cmd_src_channel;       // ARM_A9_HPS_h2f_lw_axi_master_wr_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [111:0] rsp_mux_src_data;                                              // rsp_mux:src_data -> ARM_A9_HPS_h2f_lw_axi_master_wr_limiter:rsp_sink_data
	wire          rsp_mux_src_ready;                                             // ARM_A9_HPS_h2f_lw_axi_master_wr_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                           // rsp_mux:src_channel -> ARM_A9_HPS_h2f_lw_axi_master_wr_limiter:rsp_sink_channel
	...
	wire  [111:0] arm_a9_hps_h2f_lw_axi_master_wr_limiter_rsp_src_data;          // ARM_A9_HPS_h2f_lw_axi_master_wr_limiter:rsp_src_data -> ARM_A9_HPS_h2f_lw_axi_master_agent:write_rp_data
	...
	wire    [1:0] arm_a9_hps_h2f_lw_axi_master_wr_limiter_rsp_src_channel;       // ARM_A9_HPS_h2f_lw_axi_master_wr_limiter:rsp_src_channel -> ARM_A9_HPS_h2f_lw_axi_master_agent:write_rp_channel
	...
	wire  [111:0] router_001_src_data;                                           // router_001:src_data -> ARM_A9_HPS_h2f_lw_axi_master_rd_limiter:cmd_sink_data
	wire          router_001_src_ready;                                          // ARM_A9_HPS_h2f_lw_axi_master_rd_limiter:cmd_sink_ready -> router_001:src_ready
	wire    [1:0] router_001_src_channel;                                        // router_001:src_channel -> ARM_A9_HPS_h2f_lw_axi_master_rd_limiter:cmd_sink_channel
	...
	wire  [111:0] arm_a9_hps_h2f_lw_axi_master_rd_limiter_cmd_src_data;          // ARM_A9_HPS_h2f_lw_axi_master_rd_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire    [1:0] arm_a9_hps_h2f_lw_axi_master_rd_limiter_cmd_src_channel;       // ARM_A9_HPS_h2f_lw_axi_master_rd_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire  [111:0] rsp_mux_001_src_data;                                          // rsp_mux_001:src_data -> ARM_A9_HPS_h2f_lw_axi_master_rd_limiter:rsp_sink_data
	wire          rsp_mux_001_src_ready;                                         // ARM_A9_HPS_h2f_lw_axi_master_rd_limiter:rsp_sink_ready -> rsp_mux_001:src_ready
	wire    [1:0] rsp_mux_001_src_channel;                                       // rsp_mux_001:src_channel -> ARM_A9_HPS_h2f_lw_axi_master_rd_limiter:rsp_sink_channel
	...
	wire  [111:0] arm_a9_hps_h2f_lw_axi_master_rd_limiter_rsp_src_data;          // ARM_A9_HPS_h2f_lw_axi_master_rd_limiter:rsp_src_data -> ARM_A9_HPS_h2f_lw_axi_master_agent:read_rp_data
	...
	wire    [1:0] arm_a9_hps_h2f_lw_axi_master_rd_limiter_rsp_src_channel;       // ARM_A9_HPS_h2f_lw_axi_master_rd_limiter:rsp_src_channel -> ARM_A9_HPS_h2f_lw_axi_master_agent:read_rp_channel
	...
	wire          cmd_mux_src_valid;                                             // cmd_mux:src_valid -> fifo_HPS_to_FPGA_in_csr_burst_adapter:sink0_valid
	wire  [111:0] cmd_mux_src_data;                                              // cmd_mux:src_data -> fifo_HPS_to_FPGA_in_csr_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                             // fifo_HPS_to_FPGA_in_csr_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                           // cmd_mux:src_channel -> fifo_HPS_to_FPGA_in_csr_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                                     // cmd_mux:src_startofpacket -> fifo_HPS_to_FPGA_in_csr_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                                       // cmd_mux:src_endofpacket -> fifo_HPS_to_FPGA_in_csr_burst_adapter:sink0_endofpacket
	...
	wire  [111:0] fifo_hps_to_fpga_in_csr_burst_adapter_source0_data;            // fifo_HPS_to_FPGA_in_csr_burst_adapter:source0_data -> fifo_HPS_to_FPGA_in_csr_agent:cp_data
	...
	wire    [1:0] fifo_hps_to_fpga_in_csr_burst_adapter_source0_channel;         // fifo_HPS_to_FPGA_in_csr_burst_adapter:source0_channel -> fifo_HPS_to_FPGA_in_csr_agent:cp_channel
	...
	wire          cmd_mux_001_src_valid;                                         // cmd_mux_001:src_valid -> fifo_FPGA_to_HPS_out_csr_burst_adapter:sink0_valid
	wire  [111:0] cmd_mux_001_src_data;                                          // cmd_mux_001:src_data -> fifo_FPGA_to_HPS_out_csr_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                         // fifo_FPGA_to_HPS_out_csr_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                       // cmd_mux_001:src_channel -> fifo_FPGA_to_HPS_out_csr_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                                 // cmd_mux_001:src_startofpacket -> fifo_FPGA_to_HPS_out_csr_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                   // cmd_mux_001:src_endofpacket -> fifo_FPGA_to_HPS_out_csr_burst_adapter:sink0_endofpacket
	...
	wire  [111:0] fifo_fpga_to_hps_out_csr_burst_adapter_source0_data;           // fifo_FPGA_to_HPS_out_csr_burst_adapter:source0_data -> fifo_FPGA_to_HPS_out_csr_agent:cp_data
	...
	wire    [1:0] fifo_fpga_to_hps_out_csr_burst_adapter_source0_channel;        // fifo_FPGA_to_HPS_out_csr_burst_adapter:source0_channel -> fifo_FPGA_to_HPS_out_csr_agent:cp_channel
	...
	wire    [1:0] arm_a9_hps_h2f_lw_axi_master_wr_limiter_cmd_valid_data;        // ARM_A9_HPS_h2f_lw_axi_master_wr_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire    [1:0] arm_a9_hps_h2f_lw_axi_master_rd_limiter_cmd_valid_data;        // ARM_A9_HPS_h2f_lw_axi_master_rd_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	wire          fifo_hps_to_fpga_in_csr_agent_rdata_fifo_out_valid;            // fifo_HPS_to_FPGA_in_csr_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] fifo_hps_to_fpga_in_csr_agent_rdata_fifo_out_data;             // fifo_HPS_to_FPGA_in_csr_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          fifo_hps_to_fpga_in_csr_agent_rdata_fifo_out_ready;            // avalon_st_adapter:in_0_ready -> fifo_HPS_to_FPGA_in_csr_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_out_0_valid;                                 // avalon_st_adapter:out_0_valid -> fifo_HPS_to_FPGA_in_csr_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                                  // avalon_st_adapter:out_0_data -> fifo_HPS_to_FPGA_in_csr_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                                 // fifo_HPS_to_FPGA_in_csr_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                                 // avalon_st_adapter:out_0_error -> fifo_HPS_to_FPGA_in_csr_agent:rdata_fifo_sink_error
	wire          fifo_fpga_to_hps_out_csr_agent_rdata_fifo_out_valid;           // fifo_FPGA_to_HPS_out_csr_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] fifo_fpga_to_hps_out_csr_agent_rdata_fifo_out_data;            // fifo_FPGA_to_HPS_out_csr_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          fifo_fpga_to_hps_out_csr_agent_rdata_fifo_out_ready;           // avalon_st_adapter_001:in_0_ready -> fifo_FPGA_to_HPS_out_csr_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                             // avalon_st_adapter_001:out_0_valid -> fifo_FPGA_to_HPS_out_csr_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                              // avalon_st_adapter_001:out_0_data -> fifo_FPGA_to_HPS_out_csr_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                             // fifo_FPGA_to_HPS_out_csr_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                             // avalon_st_adapter_001:out_0_error -> fifo_FPGA_to_HPS_out_csr_agent:rdata_fifo_sink_error
